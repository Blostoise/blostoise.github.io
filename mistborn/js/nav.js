 ...
 * href     -> where it links to (an in-page anchor like "#empire",
 *             or another page like "lore.html")
 * external -> optional, set to true to open the link in a new tab
 *
 * When you add the lore pages, just append entries here, e.g.:
...
const NAV_LINKS = [
  { label: "Home", href: "#top" },
  { label: "The Final Empire", href: "#empire" },
